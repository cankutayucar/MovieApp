...
namespace MovieApp.WebUI.Migrations
{
    ...
    [Migration("20210802145853_ManyToMantRelations2")]
    partial class ManyToMantRelations2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GenreMovie", b =>
                {
                    b.HasOne("MovieApp.WebUI.Entity.Genre", null)
                        .WithMany()
                        .HasForeignKey("GenresGenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieApp.WebUI.Entity.Movie", null)
                        .WithMany()
